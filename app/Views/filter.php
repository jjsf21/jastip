<div class="col-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>
        <?php if ($kunci=='view_penitip_barang') {
        }else{
        }
        ?>
      </h2>
    ...
    <div class="x_content">
      ...
      action="
      <?php if ($kunci=='view_penitip_barang') {
        echo base_url('home/cari_penitip_barang');
        }else{
          echo base_url('');
        }
        ?>" method="post">
      ...
      action="
      <?php if ($kunci=='view_penitip_barang') {
        echo base_url('home/pdf_penitip_barang');
        }else{
        echo base_url('');
          }
      ...
      action="
      <?php if ($kunci=='view_penitip_barang') {
        echo base_url('home/excel_penitip_barang');
          }else{
            echo base_url('');
          }
        ?>" method="post">
      ...
      action="
      <?php if ($kunci=='view_penitip_barang') {
        echo base_url('home/penitip_barang');
        }else{
          echo base_url('');
        }
        ?>" method="post">
